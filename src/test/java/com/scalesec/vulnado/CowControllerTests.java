...
public class CowControllerTests {
    ...
    public void cowsay_DefaultInput_ShouldReturnDefaultMessage() {
        ...
        assertEquals("Expected default message from cowsay endpoint", "I love Linux!", response.getBody());
    }
    ...
    public void cowsay_CustomInput_ShouldReturnCustomMessage() {
        ...
        assertEquals("Expected custom message from cowsay endpoint", customMessage, response.getBody());
    }
    ...
    public void cowsay_EmptyInput_ShouldReturnDefaultMessage() {
        ...
        assertEquals("Expected default message when input is empty", "I love Linux!", response.getBody());
    }
}
